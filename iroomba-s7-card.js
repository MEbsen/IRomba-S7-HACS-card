// Development builds are published automatically from this branch; maintenance state remains browser-local.
...
class IRoombaS7Card extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML=`<style>
      ...
      .scene{height:238px;margin:14px -6px;display:grid;place-items:center;position:relative;isolation:isolate;overflow:hidden;border-radius:18px;background:radial-gradient(circle at 68% 30%,color-mix(in srgb,var(--state) 17%,transparent),transparent 34%),linear-gradient(160deg,#18242d,#0d1217 62%,#151a1e)}.floor{position:absolute;inset:42% -15% -35%;background:repeating-linear-gradient(96deg,#ffffff08 0 1px,transparent 1px 54px);transform:perspective(260px) rotateX(58deg);border-top:1px solid #ffffff12}.glow{position:absolute;width:220px;height:110px;border-radius:50%;background:var(--state);filter:blur(44px);opacity:.15;transform:translateY(50px);z-index:-1}.route{position:absolute;width:230px;height:128px;opacity:${active?.8:.18}}.route path{fill:none;stroke:var(--state);stroke-width:3;stroke-linecap:round;stroke-dasharray:7 11;animation:route 2.2s linear infinite}.robotWrap{position:relative;width:150px;height:150px;display:grid;place-items:center;z-index:2;filter:drop-shadow(0 18px 14px #0009)}.robot{width:124px;height:124px;border-radius:50%;background:linear-gradient(145deg,#3c4650,#10151a);border:3px solid #66727c;box-shadow:inset 0 2px 5px #ffffff2b;position:relative}.robot:before{content:"";position:absolute;inset:17px;border-radius:50%;border:2px solid #77818a;background:radial-gradient(circle at 45% 40%,#46515a,#1b2025 68%)}.lid{position:absolute;width:38px;height:28px;border-radius:10px;left:43px;top:26px;background:#0d1115;border:2px solid #56616a}.clean{position:absolute;width:19px;height:19px;border-radius:50%;left:52px;top:64px;background:var(--state);box-shadow:0 0 14px var(--state)}.brush{position:absolute;width:46px;height:46px;right:-4px;bottom:3px}.brush:before,.brush:after{content:"";position:absolute;left:21px;width:4px;height:46px;background:#83b94b;border-radius:5px}.brush:after{transform:rotate(60deg)}.dock{position:absolute;right:25px;bottom:28px;width:50px;height:62px;border-radius:12px 12px 4px 4px;background:linear-gradient(#4d5962,#151a1f);border:2px solid #68757f;box-shadow:0 0 28px color-mix(in srgb,var(--state) 28%,transparent)}.dock:before{content:"";position:absolute;width:10px;height:10px;border-radius:50%;background:var(--state);left:18px;top:12px;box-shadow:0 0 12px var(--state)}.dock:after{content:"";position:absolute;left:-12px;right:-12px;bottom:-8px;height:12px;border-radius:10px;background:#23292e;border:2px solid #59636c}
      .cleaning .robotWrap{animation:cleanRoute 7s cubic-bezier(.45,.05,.55,.95) infinite}.cleaning .brush{animation:rotate .75s linear infinite}.returning .robotWrap{animation:returnDock 2.6s ease-in-out infinite}.charging .clean,.docked .clean{animation:pulse 2s ease-in-out infinite}.error .robot{animation:shake .5s linear infinite}.alerts{display:grid;gap:8px;margin-bottom:14px}.alert{display:flex;gap:9px;align-items:center;padding:9px 11px;border-radius:10px;font-size:13px;background:color-mix(in srgb,var(--warning-color,#ff9800) 14%,transparent)}.alert ha-icon{color:var(--warning-color,#ff9800)}
      ...
      @keyframes rotate{to{transform:rotate(360deg)}}@keyframes route{to{stroke-dashoffset:-36}}@keyframes pulse{50%{opacity:.45}}@keyframes cleanRoute{0%,100%{transform:translate(-42px,20px) rotate(-14deg)}25%{transform:translate(28px,-22px) rotate(24deg)}50%{transform:translate(46px,22px) rotate(154deg)}75%{transform:translate(-24px,-16px) rotate(205deg)}}@keyframes returnDock{0%,100%{transform:translateX(-28px) rotate(0)}55%{transform:translateX(28px) rotate(10deg)}}@keyframes shake{25%{transform:translateX(-4px)}75%{transform:translateX(4px)}}@media(max-width:420px){.card{padding:16px}.scene{height:210px}.controls{grid-template-columns:repeat(3,1fr)}}@media(prefers-reduced-motion:reduce){*{animation-duration:.001ms!important;animation-iteration-count:1!important}}
    ...
    <div class="scene ${esc(state)}"><div class="floor"></div><div class="glow"></div><svg class="route" viewBox="0 0 230 128"><path d="M18 94C42 22 102 18 116 64s54 58 96 8"/></svg><div class="robotWrap"><div class="brush"></div><div class="robot"><div class="lid"></div><div class="clean"></div></div></div><div class="dock"></div></div>
