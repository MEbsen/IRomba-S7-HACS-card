...
class IRoombaS7Card extends HTMLElement {
  ...
  render() {
    ...
    <div class="scene ${esc(state)}"><div class="floor"></div><div class="glow"></div><div class="alerts">${binFull?`<div class="alert"><ha-icon icon="mdi:delete-alert"></ha-icon>Beholderen er fuld og bør tømmes</div>`:""}${!binPresent?`<div class="alert"><ha-icon icon="mdi:delete-off"></ha-icon>Beholderen er ikke monteret</div>`:""}</div><div class="particles"><i class="dust"></i><i class="dust"></i><i class="dust"></i><i class="dust"></i><i class="dust"></i><i class="dust"></i></div><div class="returnPulse"></div><div class="returnPulse"></div><div class="robotWrap"><div class="robot"><div class="lid"></div><div class="clean"></div></div></div><div class="dock"></div></div>
    <div class="controls">${controls}</div>${maintenance?`<div class="maintenance"><div class="serviceTitle">VEDLIGEHOLDELSE</div>${maintenance}</div>`:""}${this._config.show_stats!==false&&stats?`<div class="stats">${stats}</div>`:""}</div></ha-card>`;
