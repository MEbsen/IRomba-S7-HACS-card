...
for (const value of ["iroomba-s7-card", "iroomba-s7-card-editor", "IROOMBA S7 CARD", "0.2.0", "filter_interval", "maintenanceIcons", "serviceIcon", "binIcon", "Beholderen er fuld", "floorFlow", "dustFlow", "dockInvite", "_lastCommands"]) {
