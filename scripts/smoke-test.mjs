...
for (const value of ["iroomba-s7-card", "iroomba-s7-card-editor", "IROOMBA S7 CARD", "0.2.0-dev.7", "VEDLIGEHOLDELSE", "filter_interval", "floorFlow", "dustFlow", "dockInvite", "_lastCommands"]) {
