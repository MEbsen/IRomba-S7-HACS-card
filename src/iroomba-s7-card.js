...
class IRoombaS7Card extends HTMLElement {
  ...
  getCardSize() { return this._config?.show_stats===false?4:6; }
  ...
  render() {
    ...
    this.shadowRoot.innerHTML=`<style>
      ...
      .scene{height:210px;display:grid;place-items:center;position:relative;isolation:isolate}.glow{position:absolute;width:180px;height:90px;border-radius:50%;background:var(--state);filter:blur(38px);opacity:.14;transform:translateY(45px);z-index:-1}.robotWrap{position:relative;width:150px;height:150px;display:grid;place-items:center}.robot{width:124px;height:124px;border-radius:50%;background:linear-gradient(145deg,#323940,#11161b);border:3px solid #59636c;box-shadow:0 14px 30px #0007,inset 0 2px 4px #ffffff24;position:relative}.robot:before{content:"";position:absolute;inset:17px;border-radius:50%;border:2px solid #77818a;background:radial-gradient(circle at 45% 40%,#3d464f,#1b2025 68%)}.lid{position:absolute;width:38px;height:28px;border-radius:10px;left:43px;top:26px;background:#0d1115;border:2px solid #56616a}.clean{position:absolute;width:19px;height:19px;border-radius:50%;left:52px;top:64px;background:var(--state);box-shadow:0 0 14px var(--state)}.brush{position:absolute;width:46px;height:46px;right:-4px;bottom:3px}.brush:before,.brush:after{content:"";position:absolute;left:21px;width:4px;height:46px;background:#83b94b;border-radius:5px}.brush:after{transform:rotate(60deg)}.dock{position:absolute;right:25px;bottom:24px;width:48px;height:55px;border-radius:9px;background:linear-gradient(#4a5158,#181d22);border:2px solid #68727b}.dock:after{content:"";position:absolute;left:-11px;right:-11px;bottom:-8px;height:12px;border-radius:10px;background:#23292e;border:2px solid #59636c}.track{position:absolute;width:120px;height:50px;border:2px dashed var(--state);border-radius:50%;opacity:${active?.65:0};transform:translate(-35px,54px) rotate(-8deg)}
      .cleaning .robotWrap{animation:roam 3.4s ease-in-out infinite}.cleaning .brush{animation:rotate 1s linear infinite}.returning .robot{animation:home 1.5s ease-in-out infinite}.charging .clean,.docked .clean{animation:pulse 2s ease-in-out infinite}.error .robot{animation:shake .5s linear infinite}.alerts{display:grid;gap:8px;margin-bottom:14px}.alert{display:flex;gap:9px;align-items:center;padding:9px 11px;border-radius:10px;font-size:13px;background:color-mix(in srgb,var(--warning-color,#ff9800) 14%,transparent)}.alert ha-icon{color:var(--warning-color,#ff9800)}
      .controls{display:grid;grid-template-columns:repeat(auto-fit,minmax(72px,1fr));gap:9px}button{border:1px solid var(--divider-color);background:var(--secondary-background-color);color:var(--primary-text-color);min-height:58px;border-radius:12px;padding:8px 6px;display:grid;place-items:center;gap:4px;cursor:pointer;font:inherit;font-size:12px}button.primary{background:var(--accent);color:#fff;border-color:transparent}button:disabled{opacity:.55}.stats{display:grid;grid-template-columns:repeat(auto-fit,minmax(105px,1fr));gap:8px;margin-top:14px;padding-top:14px;border-top:1px solid var(--divider-color)}.stat{background:var(--secondary-background-color);padding:9px 10px;border-radius:10px;display:grid;gap:3px;cursor:pointer}.stat span{font-size:11px;color:var(--secondary-text-color)}.stat b{font-size:14px}.missing{padding:20px}.spin{animation:rotate 1s linear infinite}
      @keyframes rotate{to{transform:rotate(360deg)}}@keyframes pulse{50%{opacity:.45}}@keyframes roam{0%,100%{transform:translateX(-13px) rotate(-2deg)}50%{transform:translateX(13px) rotate(2deg)}}@keyframes home{50%{transform:translateX(7px)}}@keyframes shake{25%{transform:translateX(-4px)}75%{transform:translateX(4px)}}@media(max-width:420px){.card{padding:16px}.scene{height:190px}.controls{grid-template-columns:repeat(3,1fr)}}@media(prefers-reduced-motion:reduce){*{animation-duration:.001ms!important;animation-iteration-count:1!important}}
